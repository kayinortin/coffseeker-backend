...
// ORDER BY id
// LIMIT 0 OFFSET 10;
const getCourseWithQS = async (where = '', order = {}, limit = 0, offset) => {
...
// 查詢單一資料，使用id
const getCourseById = async (courseId) => await findOneById(table, courseId)

// 建立大量商品資料用
const createBulkCourse = async (users) => await insertMany(table, users)
